...
# Thanks to Dries Vints https://github.com/driesvints/dotfiles/blob/master/.macos
...
# Use list view in all Finder fwindows by default
...
# Day starts at 7AM
defaults write com.apple.ical "first minute of work hours" 420
